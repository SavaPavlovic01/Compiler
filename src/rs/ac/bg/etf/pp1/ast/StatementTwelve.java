...
public class StatementTwelve extends Statement {
    ...
    public StatementTwelve (For For, ForFirst ForFirst, FirstSemi FirstSemi, ForSecond ForSecond, SecondSemi SecondSemi, Statement Statement) {
        this.For=For;
