...
public class ExprOne extends Expr {
    ...
    public ExprOne (Min Min, Term Term, AddopLoop AddopLoop) {
        this.Min=Min;
        if(Min!=null) Min.setParent(this);
        this.Term=Term;
    ...
    public void childrenAccept(Visitor visitor) {
        if(Min!=null) Min.accept(visitor);
    ...
    public void traverseTopDown(Visitor visitor) {
        accept(visitor);
        if(Min!=null) Min.traverseTopDown(visitor);
        if(Term!=null) Term.traverseTopDown(visitor);
        if(AddopLoop!=null) AddopLoop.traverseTopDown(visitor);
    }

    public void traverseBottomUp(Visitor visitor) {
        if(Min!=null) Min.traverseBottomUp(visitor);
    ...
    public String toString(String tab) {
        ...
        if(Min!=null)
            buffer.append(Min.toString("  "+tab));
        else
