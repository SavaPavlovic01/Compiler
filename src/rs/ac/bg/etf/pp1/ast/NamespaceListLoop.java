...
public class NamespaceListLoop extends NamespaceList {

    private NamespaceList NamespaceList;
    private Namespace Namespace;

    public NamespaceListLoop (NamespaceList NamespaceList, Namespace Namespace) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NamespaceListLoop(\n");
