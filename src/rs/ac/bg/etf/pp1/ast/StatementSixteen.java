...
public class StatementSixteen extends Statement {
    ...
    public StatementSixteen (For For, ForFirst ForFirst, FirstSemi FirstSemi, SecondSemi SecondSemi, Statement Statement) {
        this.For=For;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementSixteen(\n");
