...
public class ForFirstOne extends ForFirst {

    private DesignatorStatement DesignatorStatement;
    private ForFirstLoop ForFirstLoop;

    public ForFirstOne (DesignatorStatement DesignatorStatement, ForFirstLoop ForFirstLoop) {
