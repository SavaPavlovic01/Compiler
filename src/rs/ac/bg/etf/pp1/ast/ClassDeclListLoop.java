...
public class ClassDeclListLoop extends ClassDeclList {

    private ClassDeclList ClassDeclList;
    private ClassDecl ClassDecl;

    public ClassDeclListLoop (ClassDeclList ClassDeclList, ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclListLoop(\n");
