...
public class ProgramOne extends Program {
    ...
    public ProgramOne (ProgName ProgName, NamespaceList NamespaceList, DeclLists DeclLists, MethodDeclList MethodDeclList) {
