...
public class FormParsLoopArr extends FormParsLoop {

    private FormParsLoop FormParsLoop;
    private Type Type;
    private FormParName FormParName;

    public FormParsLoopArr (FormParsLoop FormParsLoop, Type Type, FormParName FormParName) {
