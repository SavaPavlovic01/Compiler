...
public class ProgramFour extends Program {

    private ProgName ProgName;
    private NamespaceList NamespaceList;
    private MethodDeclList MethodDeclList;

    public ProgramFour (ProgName ProgName, NamespaceList NamespaceList, MethodDeclList MethodDeclList) {
